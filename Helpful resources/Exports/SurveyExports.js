...
export class SurveyExports extends React.Component {
  ...
  async componentDidMount() {
    ...
    const incomingData = await axios.get("http://localhost:5000/api/exports/fields/survey");
  ...
  async refreshFilters() {
    ...
    const incomingFilters = await axios.post("http://localhost:5000/api/exports/surveyfilters/get-by-username", refreshFiltersJson);
  ...
  async submitForm() {
    ...
    const resp = await axios.post("http://localhost:5000/api/exports/csv/survey", outgoingJson, {responseType: 'blob'});
  ...
  async saveFilters() {
    const filter_set = {
      ...
      await axios.post("http://localhost:5000/api/exports/surveyfilters/save", filter_set);
  ...
  async loadFilterSet(e) {
    ...
    const filter_set = await axios.post("http://localhost:5000/api/exports/surveyfilters/get", getfilterSetJson);
