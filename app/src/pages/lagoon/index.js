    ...
    displayBlock = (
      <div className="container-fluid">
          ...
          <label htmlFor="species" className="col-3 col-form-label">Species:</label>
              ...
              <div className="col-5">
                <input type="text" className="form-control" placeholder="other" name="species_other" onChange={e => this.onChange(e)}/>
              </div>
          </div>
          ...
          <label htmlFor="species" className="col-2 col-form-label mb-3 mr-0 pr-0 no-gutters">Tag #:</label>
              ...
              <input type="text" className="form-control" name="tag_number" onChange={e => this.onChange(e)}/>
              </div>
