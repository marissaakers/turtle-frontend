      ...
      <>
        ...
        <div className="container-fluid">
            ...
            <div className="form-group row">
              ...
              <div className="col-6">
              <input className="form-control" type="text" name="tag_number" onChange={e => this.onChange(e)}/>
              </div>
            </div>
          ...
          <h4>Tag Scars:</h4>
            ...
            <div className="form-row">
              <div className="form-group col-md-5">
                <label htmlFor="tag-scars-lf">LF:</label>
              ...
              <div className="form-group col-md-5">
                <label htmlFor="tag-scars-rf">RF:</label>
