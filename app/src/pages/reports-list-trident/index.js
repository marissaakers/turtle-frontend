...
import ReportsListTabs from '../../components/reports-list-nav';
import '../shared/internal.css';


const TITLE = 'MTRG - Reports list for Trident'

class ReportsListTrident extends React.Component {
  constructor(props) {
    super(props);
  ...
  async loadReportsList(json) {
    ...
    const data = await axios.post(
      'https://no1unm6ijk.execute-api.us-east-1.amazonaws.com/dev/api/capture/trident/mini_query',
      json,
  ...
  mySubmitHandler = (event) => {
    ...
    function formReplacer (key, value) {
      ...
      else if (key === 'turtle_id' || key === 'encounter_id' || key === 'metadata_id') {
  ...
  render() {
    ...
    let pageBody = (
      <>
        <h3>MTRG - Reports List for Trident</h3>
    ...
    return(
      <>
        ...
        <ReportsListTabs content={pageBody} selectedTab={"trident"} />
...
export default ReportsListTrident;
