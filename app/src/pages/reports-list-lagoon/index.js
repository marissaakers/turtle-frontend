...
const TITLE = 'MTRG - Reports list for Lagoon'
...
class ReportsListLagoon extends React.Component {
  ...
  async loadReportsList(json) {
    ...
    const data = await axios.post(
      'https://no1unm6ijk.execute-api.us-east-1.amazonaws.com/dev/api/capture/lagoon/mini_query',
      json,
  ...
  render() {
    ...
    return(
      <>
        ...
        <ReportsListTabs content={pageBody} selectedTab={"lagoon"} />
        <InternalFooter />
      </>
    )
  }
...
export default ReportsListLagoon;
