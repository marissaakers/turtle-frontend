...
const TITLE = 'MTRG - Reports list for Offshore'
...
class ReportsListOffshore extends React.Component {
  ...
  async loadReportsList(json) {
    ...
    const data = await axios.post(
      'https://no1unm6ijk.execute-api.us-east-1.amazonaws.com/dev/api/capture/offshore/mini_query',
      json,
  ...
  render() {
    ...
    let pageBody = (
      <>
        <h3>MTRG - Reports List for Offshore</h3>
    ...
    return(
      <>
        ...
        <ReportsListTabs content={pageBody} selectedTab={"offshore"} />
...
export default ReportsListOffshore;
