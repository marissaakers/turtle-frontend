...
export class SurveyExports extends React.Component {
  ...
  async componentDidMount() {
    ...
    const incomingData = await axios.get("https://no1unm6ijk.execute-api.us-east-1.amazonaws.com/dev/api/exports/fields/survey");
  ...
  async refreshFilters() {
    ...
    const incomingFilters = await axios.post("https://no1unm6ijk.execute-api.us-east-1.amazonaws.com/dev/api/exports/surveyfilters/get-by-username", refreshFiltersJson);
  ...
  async submitForm() {
    ...
    const resp = await axios.post("https://no1unm6ijk.execute-api.us-east-1.amazonaws.com/dev/api/exports/csv/survey", outgoingJson, {responseType: 'blob'});
  ...
  async saveFilters() {
    const filter_set = {
      ...
      await axios.post("https://no1unm6ijk.execute-api.us-east-1.amazonaws.com/dev/api/exports/surveyfilters/save", filter_set);
  ...
  async loadFilterSet(e) {
    ...
    const filter_set = await axios.post("https://no1unm6ijk.execute-api.us-east-1.amazonaws.com/dev/api/exports/surveyfilters/get", getfilterSetJson);
  ...
  render() {
    if (this.state.isLoading) return (
      ...
      <div className="w-50">
          ...
          <h2 class="text-center">Survey Data Tables</h2>
          <div id="accordion">
            {
              Object.entries(data).map(([table, columns]) => (
